...
set_target_properties(sfml-system PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libsfml-system.so.2.6.2"
  IMPORTED_SONAME_NOCONFIG "libsfml-system.so.2.6"
  )

list(APPEND _cmake_import_check_targets sfml-system )
list(APPEND _cmake_import_check_files_for_sfml-system "${_IMPORT_PREFIX}/lib64/libsfml-system.so.2.6.2" )
...
set_target_properties(sfml-window PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libsfml-window.so.2.6.2"
  IMPORTED_SONAME_NOCONFIG "libsfml-window.so.2.6"
  )

list(APPEND _cmake_import_check_targets sfml-window )
list(APPEND _cmake_import_check_files_for_sfml-window "${_IMPORT_PREFIX}/lib64/libsfml-window.so.2.6.2" )
...
set_target_properties(sfml-network PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libsfml-network.so.2.6.2"
  IMPORTED_SONAME_NOCONFIG "libsfml-network.so.2.6"
  )

list(APPEND _cmake_import_check_targets sfml-network )
list(APPEND _cmake_import_check_files_for_sfml-network "${_IMPORT_PREFIX}/lib64/libsfml-network.so.2.6.2" )
...
set_target_properties(sfml-graphics PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libsfml-graphics.so.2.6.2"
  IMPORTED_SONAME_NOCONFIG "libsfml-graphics.so.2.6"
  )

list(APPEND _cmake_import_check_targets sfml-graphics )
list(APPEND _cmake_import_check_files_for_sfml-graphics "${_IMPORT_PREFIX}/lib64/libsfml-graphics.so.2.6.2" )
...
set_target_properties(sfml-audio PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libsfml-audio.so.2.6.2"
  IMPORTED_SONAME_NOCONFIG "libsfml-audio.so.2.6"
  )

list(APPEND _cmake_import_check_targets sfml-audio )
list(APPEND _cmake_import_check_files_for_sfml-audio "${_IMPORT_PREFIX}/lib64/libsfml-audio.so.2.6.2" )
