...
namespace Network {
    ...
    class ReliableLayerAdapter {
        public:
            using AppPacketCallback = std::function<void(const Network::Packet&, const endpoint_t&)>;
        ...
        private:
            void onTransportRecv(const std::vector<uint8_t>& data, const endpoint_t& from);
